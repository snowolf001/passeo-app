...
export default function MemberCreditsScreen({navigation}: Props) {
  ...
  // When the modal is open, replace the native header back button with a
  // custom ← that closes the modal instead of navigating away.
  useEffect(() => {
                      ...
                      <View style={styles.section}>
                        ...
                        <View style={styles.roleRow}>
                          <TouchableOpacity
                            ...
                            disabled={
                              changingRole || selected.role === 'member'
                            }>
                            <Text
                              style={[
                                styles.roleBtnText,
