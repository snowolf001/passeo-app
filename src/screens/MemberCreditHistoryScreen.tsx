...
type Props = NativeStackScreenProps<RootStackParamList, 'MemberCreditHistory'>;
...
export default function MemberCreditHistoryScreen({route}: Props) {
  ...
  const loadTransactions = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await getMemberCreditTransactions(membershipId);
